-- First, let's drop the problematic function and recreate it with proper null handling
DROP FUNCTION IF EXISTS public.log_settings_change() CASCADE;

-- Create a new version that handles null admin_id
...
AS $function$
BEGIN
  -- Only log if we have a valid admin_id (skip during seeding)
